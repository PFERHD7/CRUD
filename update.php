...
if(isset($_POST["id"]) && !empty($_POST["id"])){
    ...
    if(empty($input_address)){
        $address_err = "Por favor ingrese una descripción.";     
    } else{
    ...
    if(empty($input_salary)){
        $salary_err = "Por favor ingrese el monto de la existencia.";     
    ...
    if(empty($name_err) && empty($address_err) && empty($salary_err)){
        ...
        $sql = "UPDATE product SET name=?, description=?, stock=? WHERE id=?";
